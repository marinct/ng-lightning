...
export class NglFormGroupElement implements OnChanges, AfterContentInit {
  ...
  constructor(@Optional() public groupAlt: NglFormGroupAlternate, private element: ElementRef, private renderer: Renderer2) {}
