...
export { NglModule } from './lib/ng-lightning.module';
...
// Configuration
export { NGL_COLORPICKER_CONFIG, NglColorpickerConfig } from './lib/colorpicker/config';
...
export { NGL_TOOLTIP_CONFIG, NglTooltipConfig } from './lib/tooltips/config';
