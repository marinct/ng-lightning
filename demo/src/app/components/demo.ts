...
const demos: any = [
  ...
  { key: 'notifications', ts: require('!!raw-loader!./demo/notifications/notifications.ts'), html: require('!!raw-loader!./demo/notifications/notifications.html'), readme: require('html-loader?minimize=false!markdown-loader!./demo/notifications/README.md'), api: require('html-loader?minimize=false!markdown-loader!./demo/notifications/API.md') },
